  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
         <KPICard title="Net Balance" value={formatCurrency(metrics.balance)} badgeColor="violet" icon={Landmark} changeStr="4.2%" isPositive={true} delay={1} />
             ...
             {recentTx.map((t, index) => (
               <div key={t.id} className={`flex justify-between items-center bg-[var(--color-popover)]/50 py-[8px] px-0 md:p-2.5 md:rounded-none border-b md:border md:border-[var(--color-border-subtle)] border-gray-800 ${index === 4 ? 'hidden md:flex' : ''}`}>
                 <div className="flex items-center gap-3">
                   <div className="w-8 h-8 rounded-none bg-[var(--color-elevated)] flex items-center justify-center text-[var(--color-text-secondary)] border border-[var(--color-border-subtle)]">
